...
export const SEEDED_MEMORIES: MemoryFact[] = [
  {
    ...
    content: 'Test User is the administrator of the test account. Primary email: test-user@example.invalid, secondary: test-backup@example.invalid.',
  ...
  },
  {
    id: 'mem-14',
    domain: 'personal',
    title: 'Conference Travel Flight Itinerary',
    content: 'Flight to Seattle for ACME Tech Conference is booked for September 14, 2026 at 19:00 EDT (flight ACME-1), returning September 21, 2026 at 14:30 EDT.',
    observedAt: '2026-09-01T16:00:00.000Z',
    status: 'active',
    validUntil: '2026-09-22T00:00:00.000Z',
    tags: ['travel', 'flight', 'conference', 'itinerary'],
  },
  {
    id: 'mem-15',
    domain: 'reference',
