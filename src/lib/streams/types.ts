...
/** User speech transcription arriving from realtime provider / STT */
export interface StreamInputTranscriptionEvent extends BaseStreamEvent {
...
/** Assistant speech transcription generated by realtime provider */
export interface StreamOutputTranscriptionEvent extends BaseStreamEvent {
...
export type StreamEvent =
  ...
  | StreamTextInEvent
  | StreamTextOutEvent
  | StreamInputTranscriptionEvent
  | StreamOutputTranscriptionEvent
  | StreamToolCallEvent
