...
export const Assistant = {
    addVectorFile, cancelRun, createAssistant, createBatch, createMessage, createThread, createVector, createVoice, deleteAssistant, deleteBatch, deleteFile, deleteMessage, deleteThread, deleteVector, deleteVectorFile, editAssistant, editMessage, editRun, editThread, editVector, getAssistant, getBatch, getFile, getMessage, getRun, getThread, getVector, getVectorFile, listBatches, listFiles, listMessages, listRuns, listVectorFiles, listVectors, readFile, runThread, submitTools, uploadFile
}
