 ...
 */
function executeLoop(config, state) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        console.log('[LoopExecutor] Steps count:', (_a = config.steps) === null || _a === void 0 ? void 0 : _a.length);
        ...
        if (DEBUG) {
            console.log(`[LoopExecutor] Starting loop (max: ${maxIterations}, steps: ${(steps === null || steps === void 0 ? void 0 : steps.length) || 0})`);
        }
        ...
        const loopState = Object.assign({}, state);
        while (iteration < maxIterations && !exitConditionMet) {
            ...
            for (let stepIndex = 0; stepIndex < steps.length; stepIndex++) {
                ...
                try {
                    ...
                    const iterationState = Object.assign(Object.assign({}, loopState), { data: Object.assign(Object.assign({}, (loopState.data || {})), { loopIteration: iteration, loopAccumulator: accumulatorArray }) });
                    // Execute step
                    const stepUpdate = yield (0, stepExecutor_1.executeStep)(step, iterationState);
            ...
            try {
                exitConditionMet = evaluateExitCondition(exitCondition, Object.assign(Object.assign({}, loopState), { data: Object.assign(Object.assign({}, (loopState.data || {})), { loopIteration: iteration, loopAccumulator: accumulatorArray }) }));
                if (exitConditionMet) {
                    if (DEBUG)
 ...
 */
function evaluateExitCondition(condition, state) {
    try {
