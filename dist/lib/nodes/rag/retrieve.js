...
exports.retrieveFromVectorStoreNode = void 0;
 ...
 */
function formatContextForLLM(results, query, mergeChunks = true) {
    if (results.length === 0) {
        return '';
    }
    ...
    const sections = processedResults.map((result, index) => {
        ...
        const mergedCount = ((_b = result.metadata) === null || _b === void 0 ? void 0 : _b.mergedChunks) || 1;
 ...
 */
const retrieveFromVectorStoreNode = (state) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b;
    ...
    try {
        ...
        const queryText = state.ragQuery || ((_a = state.query) === null || _a === void 0 ? void 0 : _a.message);
        if (!queryText) {
        ...
        const vectorStore = new vectors_1.VectorStoreManager(((_b = redInstance === null || redInstance === void 0 ? void 0 : redInstance.config) === null || _b === void 0 ? void 0 : _b.vectorDbUrl) || process.env.CHROMA_URL || 'http://localhost:8024', 
        ...
        // Perform search
        const results = yield vectorStore.search(collectionName, queryText, searchConfig);
...
exports.retrieveFromVectorStoreNode = retrieveFromVectorStoreNode;
