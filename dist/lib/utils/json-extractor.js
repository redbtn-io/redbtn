...
exports.extractJSONWithDetails = extractJSONWithDetails;
/**
 ...
 */
function extractJSON(text, expectedShape) {
 ...
 */
function isValidJSON(parsed, expectedShape) {
    // Must be an object
...
function extractJSONWithDetails(text, expectedShape) {
    const result = {
        success: false,
        data: null,
        rawText: text
