...
exports.RagServerSSE = void 0;
const server_sse_1 = require("../server-sse");
const vectors_1 = require("../../memory/vectors");
class RagServerSSE extends server_sse_1.McpServerSSE {
    constructor(name, version, port = 3003, chromaUrl, ollamaUrl) {
        ...
        this.vectorStore = new vectors_1.VectorStoreManager(this.chromaUrl, this.ollamaUrl);
    ...
    addDocument(args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const collection = args.collection || 'general';
            ...
            try {
                const isHealthy = yield this.vectorStore.healthCheck();
                if (!isHealthy) {
                ...
                const chunksAdded = yield this.vectorStore.addDocument(collection, text, fullMetadata, chunkingConfig);
    ...
    searchDocuments(args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const results = yield this.vectorStore.search(collection, query, searchConfig);
    ...
    deleteDocuments(args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                let deletedCount = 0;
                if (ids && ids.length > 0) {
                    deletedCount = yield this.vectorStore.deleteDocuments(collection, ids);
                }
                else if (filter) {
                    deletedCount = yield this.vectorStore.deleteByFilter(collection, filter);
                }
    ...
    listCollections() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const collections = yield this.vectorStore.listCollections();
    ...
    getCollectionStats(args) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const stats = yield this.vectorStore.getCollectionStats(collection);
...
exports.RagServerSSE = RagServerSSE;
